...
public class YoutubeDL {
    ...
    public static YoutubeDLResponse execute(YoutubeDLRequest request, DownloadProgressCallback callback) throws YoutubeDLException {
        ...
        List<String> commandWithOptions = request.buildCommandWithOptions();
        ...
        youtubeDLResponse = new YoutubeDLResponse(commandWithOptions.toString(), options, directory, exitCode , elapsedTime, out, err);
